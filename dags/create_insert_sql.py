...
match_table_insert = ('''INSERT INTO match (match_id, match_type, url, game, state) VALUES (%s,%s,%s,%s,%s) 
ON CONFLICT (match_id) DO UPDATE SET match_type = EXCLUDED.match_type, url = EXCLUDED.url, game = EXCLUDED.game, state = EXCLUDED.state;''')
...
playermatch_table_insert = ('''INSERT INTO playermatch (user_id, match_id, entity_id, page_url, event_timestamp, current_round) VALUES (%s,%s,%s,%s,%s,%s);''')
